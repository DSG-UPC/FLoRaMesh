...
#ifndef __LORA_OMNET_SIMPLELORAMESHAPP_H_
#define __LORA_OMNET_SIMPLELORAMESHAPP_H_
 ...
 */
class INET_API SimpleLoRaMeshApp : public cSimpleModule, public ILifecycle
{
    protected:
