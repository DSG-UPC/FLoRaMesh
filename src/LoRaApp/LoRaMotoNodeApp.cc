...
#include "LoRaMotoNodeApp.h"

#include "inet/mobility/static/StationaryMobility.h"
namespace inet {

Define_Module(LoRaMotoNodeApp);

void LoRaMotoNodeApp::initialize(int stage)
{
...
std::pair<double,double> LoRaMotoNodeApp::generateUniformCircleCoordinates(double radius, double gatewayX, double gatewayY)
{
...
void LoRaMotoNodeApp::handleMessage(cMessage *msg)
{
...
void LoRaMotoNodeApp::handleMessageFromLowerLayer(cMessage *msg)
{
...
bool LoRaMotoNodeApp::handleOperationStage(LifecycleOperation *operation, int stage, IDoneCallback *doneCallback)
{
    Enter_Method_Silent();
...
void LoRaMotoNodeApp::sendJoinRequest()
{
...
void LoRaMotoNodeApp::increaseSFIfPossible()
{
    if(loRaSF < 12) loRaSF++;
}
