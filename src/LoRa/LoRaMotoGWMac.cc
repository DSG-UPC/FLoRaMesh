...
Define_Module(LoRaMotoGWMac);

void LoRaMotoGWMac::initialize(int stage)
{
...
InterfaceEntry *LoRaMotoGWMac::createInterfaceEntry()
{
...
void LoRaMotoGWMac::handleSelfMessage(cMessage *msg)
{
    if(msg == dutyCycleTimer) waitingForDC = false;
}

void LoRaMotoGWMac::handleUpperPacket(cPacket *msg)
{
...
void LoRaMotoGWMac::sendPacketBack(LoRaMacFrame *receivedFrame)
{
...
void LoRaMotoGWMac::createFakeLoRaMacFrame()
{

}

void LoRaMotoGWMac::receiveSignal(cComponent *source, simsignal_t signalID, long value, cObject *details)
{
    Enter_Method_Silent();
...
DevAddr LoRaMotoGWMac::getAddress()
{
    return address;
}
